...
for lang in ${LANGUAGES}; do
  ...
  mv ./config/alerts/i18n/messages.properties ./config/alerts/i18n/messages_\${lang}.properties

  # bie-hub
  crowdin file download -l \${lang} --project-id=${PROJECT_ID} --token="${CROWDIN_TOKEN}" bie-hub/messages.properties -d ./config/bie-hub/i18n
  mv ./config/bie-hub/i18n/messages.properties ./config/bie-hub/i18n/messages_\${lang}.properties
  ...
  mv ./config/bie-index/i18n/messages.properties ./config/bie-index/i18n/messages_\${lang}.properties
  ...
  mv ./config/biocache-hub/i18n/messages_en.properties ./config/biocache-hub/i18n/messages_\${lang}.properties
  ...
  mv ./config/biocache-hub/i18n/downloads-plugin/messages.properties ./config/biocache-hub/i18n/downloads-plugin/messages_\${lang}.properties
  ...
  mv ./config/biocache-service/i18n/messages.properties ./config/biocache-service/i18n/messages_\${lang}.properties
  ...
  mv ./config/collectory/i18n/messages.properties ./config/collectory/i18n/messages_\${lang}.properties
  ...
  mv ./config/doi-service/i18n/messages.properties ./config/doi-service/i18n/messages_\${lang}.properties
  ...
  mv ./config/image-service/i18n/messages.properties ./config/image-service/i18n/messages_\${lang}.properties

  # logger
  crowdin file download -l \${lang} --project-id=${PROJECT_ID} --token="${CROWDIN_TOKEN}" logger/messages.properties -d ./config/logger/i18n
  mv ./config/logger/i18n/messages.properties ./config/logger/i18n/messages_\${lang}.properties

  # regions
  crowdin file download -l \${lang} --project-id=${PROJECT_ID} --token="${CROWDIN_TOKEN}" regions/messages.properties -d ./config/regions/i18n
  mv ./config/regions/i18n/messages.properties ./config/regions/i18n/messages_\${lang}.properties
  ...
  mv ./config/spatial-hub/i18n/messages.properties ./config/spatial-hub/i18n/messages_\${lang}.properties
  ...
  mv ./config/spatial-service/i18n/messages.properties ./config/spatial-service/i18n/messages_\${lang}.properties
  ...
  mv ./config/species-list/i18n/messages.properties ./config/species-list/i18n/messages_\${lang}.properties
  ...
  mv ./config/userdetails/i18n/messages.properties ./config/userdetails/i18n/messages_\${lang}.properties
