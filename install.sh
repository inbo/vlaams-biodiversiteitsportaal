...
../../.venv/bin/ansible-playbook -u vagrant -e ansible_user=vagrant -i la-flanders-inventory.ini -i la-flanders-local-extras.ini -i la-flanders-local-passwords.ini -i ../la-flanders-pre-deploy/inventory.yml ../la-flanders-pre-deploy/pre-deploy.yml
...
# ../../.venv/bin/ansible-playbook -u vagrant -e ansible_user=vagrant -i la-flanders-inventory.ini -i la-flanders-local-extras.ini -i la-flanders-local-passwords.ini $AI/ansible/spatial-by-type.yml --limit vm-3 -e postgis_scripts_version=3.2
