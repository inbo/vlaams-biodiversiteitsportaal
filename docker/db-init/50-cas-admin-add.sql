...
INSERT INTO users (userid, username, firstname, lastname, email, activated, locked, temp_auth_key)
    ...
    FROM (SELECT 1 as userid, 'support@la-flanders.org' as username, 'Admin' as firstname, 'User' as lastname, 'support@la-flanders.org' as email, '1' as activated, '0' as locked, 'd9b58186-ad9c-4ef2-b026-9959f9659997' as temp_auth_key) t
...
INSERT INTO passwords (userid, password, type, status)
    ...
    FROM (SELECT 1 as userid,'$2y$10$Vqm30rBsLvH85GZj/Q3GCuFTRmueAQIUWNjjLOvpHGwAa8Ljm.TWi' as password, 'bcrypt' as type, 'CURRENT' as status) t
